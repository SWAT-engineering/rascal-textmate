...
list[ConversionUnit] units = [
    unit(rsc, prod(lex("delimiters"),[alt({lit("top-down-break"),lit("bottom-up-break"),lit("/="),lit("⇨"),lit("≫"),lit("\n"),lit("!:="),lit("\'"),lit("\<\<="),lit("!="),lit("\>="),lit("/*"),lit("://"),lit("non-assoc"),lit("&="),lit("\<-"),lit("*="),lit("+="),lit("*/"),lit("%"),lit("!\<\<"),lit("=\>"),lit("!\>\>"),lit("||"),lit("\>\>"),lit("::"),lit("⚠"),lit("&&"),lit(":="),lit("#"),lit("\<==\>"),lit("\""),lit("?="),lit("==\>"),lit("^"),lit("-="),lit("$T")})],{})),
    ...
    unit(rsc, prod(lex("Comment"),[lit("//"),conditional(\iter-star(\char-class([range(1,9),range(11,1114111)])),{\not-follow(\char-class([range(9,9),range(13,13),range(32,32),range(160,160),range(5760,5760),range(8192,8202),range(8239,8239),range(8287,8287),range(12288,12288)])),\end-of-line()})],{\tag("category"("Comment"))}), ignoreDelimiterPairs = true),
