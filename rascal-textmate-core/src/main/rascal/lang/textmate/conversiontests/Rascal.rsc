...
list[ConversionUnit] units = [
    ...
    unit(rsc, prod(lex(DELIMITERS_PRODUCTION_NAME),[alt({lit("-"),lit(")"),lit("\'"),lit("&"),lit("non-assoc"),lit("&="),lit("\<-"),lit("*="),lit("+="),lit("top-down-break"),lit(","),lit("bottom-up-break"),lit("/"),lit("..."),lit("/="),lit("."),lit("⇨"),lit("("),lit("≫"),lit("+"),lit("*"),lit("\n"),lit("*/"),lit("%"),lit("\\`"),lit("!:="),lit("$"),lit("\<="),lit("!\<\<"),lit("!"),lit("=\>"),lit("!\>\>"),lit("=="),lit("\>\>"),lit("\\\<"),lit("::"),lit("⚠"),lit("//"),lit(".."),lit("&&"),lit("`"),lit("@"),lit("||"),lit("\\\\"),lit("\<\<"),lit(":="),lit("#"),lit("\\\>"),lit("\<==\>"),lit("\""),lit("bottom-up"),lit("\<\<="),lit("="),lit("}"),lit("]"),lit("|"),lit("\\"),lit("!="),lit("\<"),lit("\>="),lit("?"),lit("?="),lit("\<:"),lit("==\>"),lit("\>"),lit("^"),lit("/*"),lit(";"),lit("{"),lit("["),lit("://"),lit("top-down"),lit(":"),lit("-="),lit("$T")})],{})),
